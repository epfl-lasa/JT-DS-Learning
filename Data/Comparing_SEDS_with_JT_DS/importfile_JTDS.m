function TheRobotTrajectory1 = importfile_JTDS(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   THEROBOTTRAJECTORY1 = IMPORTFILE1(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   THEROBOTTRAJECTORY1 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   TheRobotTrajectory1 = importfile1('TheRobotTrajectory1.txt', 1, 10909);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/03/14 21:29:58
...
TheRobotTrajectory1 = [dataArray{1:end-1}];
