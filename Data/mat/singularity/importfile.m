function TheRobotTrajectory1 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   THEROBOTTRAJECTORY1 = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   THEROBOTTRAJECTORY1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   TheRobotTrajectory1 = importfile('TheRobotTrajectory1.txt', 1, 6824);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/09/10 16:34:56
